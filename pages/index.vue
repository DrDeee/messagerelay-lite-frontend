  ...
  <div>
    ...
    <div v-else>
      <div
        ...
        :key="msg.id"
        v-bind:class="
          (msg.deleted == true ? '' : 'not-deleted border-secondary ') +
          'border m-2 rounded'
        "
      >
        <div v-html="msg.content" class="p-2 msg" />
        <div class="border-top text-center" v-if="msg.deleted">Gelöscht</div>
        <div v-bind:class="'border-top p-1 fs-6' + (msg.deleted ? '' : ' border-secondary')">
          <div class="row">
